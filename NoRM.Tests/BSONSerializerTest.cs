...
namespace Norm.Tests
{
    ...
    {       
        ...
        {
            var obj1 = new DiscriminatedChildGeneralDTO { Pi = 3.14, IsUnder9000 = true };
            var hydratedObj1 = (DiscriminatedChildGeneralDTO)BsonDeserializer.Deserialize<GeneralDTO>(BsonSerializer.Serialize(obj1));
            Assert.Equal(obj1.Pi, hydratedObj1.Pi);
            Assert.Equal(obj1.IsUnder9000, hydratedObj1.IsUnder9000);
        }
