...
namespace BSONLib
{
    ...
    {
        private static Dictionary<WeakReference, MongoFlyweight> _expandoProps = new Dictionary<WeakReference, MongoFlyweight>(0);
        ...
        public static MongoFlyweight FlyWeightForObject<T>(T document)
        {
            MongoFlyweight retval = null;
        ...
        public static void SetFlyWeightObjects(IDictionary<WeakReference,MongoFlyweight> props)
        {
                    ...
                    if (ExpandoProps._scrubExpandos == null)
                    {
                        ExpandoProps._scrubExpandos = new Thread(() =>
                        {
                            while (true)
                            {
                                ...
                                ExpandoProps._expandoProps = new Dictionary<WeakReference, MongoFlyweight>(
        ...
        public static void Set<T>(this IMongoFlyweight obj, String propertyName, T property)
        {
            ExpandoProps._dictionaryLock.EnterWriteLock();
            ...
            if (dict.Key == null)
            {
                ...
                ExpandoProps._expandoProps[reference] = new MongoFlyweight();
            }
