...
namespace BSONLib
{
    ...
    public static class BSONSerializer
    {
        ...
        public static byte[] Serialize<T>(T document, bool includeExpandoProps)
        {
            ...
            MongoFlyweight props = null;
            if (includeExpandoProps)
            {
                props = ExpandoProps.FlyWeightForObject<T>(document);
            }
        ...
        /// <returns></returns>
        public static T Deserialize<T>(BinaryReader stream, ref IDictionary<WeakReference, MongoFlyweight> outProps) where T : class, new()
        {
        ...
        /// <returns></returns>
        public static T Deserialize<T>(byte[] objectData, ref IDictionary<WeakReference, MongoFlyweight> outProps) where T : class, new()
        {
        ...
        {
            IDictionary<WeakReference, MongoFlyweight> outprops = new Dictionary<WeakReference, MongoFlyweight>();
        ...
        /// <returns></returns>
        private static object Deserialize(BinaryReader stream, ref IDictionary<WeakReference, MongoFlyweight> outProps, Type returnType)
        {
        ...
        /// <returns></returns>
        private static object DeserializeMember(BSONTypes t, byte[] objectData, Type proptype, out int usedBytes, ref IDictionary<WeakReference, MongoFlyweight> outProps)
        {
            object retval = null;
            usedBytes = 0;
            //type + name + data
